import type { Game, GameDetail, PlayerGameStat, ChampionKdaStat, ChampionPickStat, ChampionBanStat, ParsedGame } from '@/types';
...
export async function parseScreenshot(file: File): Promise<{ tempFile: string; parsed: ParsedGame }> {
...
export function saveGame(tempFile: string, parsed: ParsedGame): Promise<{ id: string }> {
