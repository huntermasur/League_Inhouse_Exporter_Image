  ...
  return (
    <>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={data} margin={{ top: 4, right: 16, bottom: 60, left: 8 }}>
          ...
          <XAxis
            ...
            tickLine={false}
          />
          <YAxis tick={chartTheme.tick} axisLine={false} tickLine={false} label={{ value: 'Average', angle: -90, position: 'insideLeft', fill: '#5a6478', fontSize: 11 }} />
          ...
          <Bar dataKey="avg_assists" name="AVERAGE of A" fill={chartTheme.gold} />
        </BarChart>
      </ResponsiveContainer>
    </>
  );
